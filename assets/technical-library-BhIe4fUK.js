import{H as i}from"./Header-Ds_h2UO5.js";const r={header:{technology:"Technology",applications:"Applications",impact:"Impact",partner:"Home",partnerLink:"/",technicalLibrary:"Technical Library"}},a=()=>console.log("Lang toggle not implemented on this static page"),s="en";document.querySelector("#app").innerHTML=`
            ...
            <main style="padding-top: 100px; min-height: 80vh; background-color: #f8f9fa;">
                <div class="container">
                    ...
                    <div class="document-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 2rem;">
