import"./modulepreload-polyfill-B5Qt9EMX.js";import{H as n}from"./Header-1Rkqf7pX.js";const r={header:{technology:"Technology",applications:"Applications",impact:"Impact",partner:"Home",partnerLink:"/",technicalLibrary:"Technical Library"}},s=()=>console.log("Lang toggle not implemented on this static page"),a="en";document.querySelector("#app").innerHTML=`
            ${n({content:r.header,toggleLang:s,currentLang:a})}
            <main style="padding-top: 80px; min-height: 80vh; background-color: #f8f9fa;">
                <div class="container" style="max-width: 1200px;">
                    <h1 style="margin-bottom: 0.5rem; color: var(--color-primary);">Technical Library</h1>
                    <p style="margin-bottom: 1.5rem; color: var(--color-text-muted);">Access our technical documentation, test reports, and presentations.</p>
